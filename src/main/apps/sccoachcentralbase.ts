...
import { IPCAppType, IPCDatabaseData, IPCFormScoutData, IPCGetTeamsOptions, IPCGraphConfig, IPCMatchInfo, IPCPickListConfig, IPCPickListData, IPCProjColumnsConfig, IPCMatchPredictorRequest, IPCMatchPredictorData, IPCMatchPredictorTeam } from "../../shared/ipc";
